...
<h2>Saturday Tea-Set Gatherings</h2>
<p>Tea-Set Gatherings are the best reviews, as we have a variety of choices in terms of location and cuisine, it is always something unique for the elderly to try.</br>
From Dim-sum to Western cuisine as well as locations of local spots to posh restaurants. We provide these activities to ensure a good time for the elderly! 
</p>
...
<div class="row">
  ...
  <div class="column">
    <img src={{ asset("img/teagathering2jpg.jpg") }} alt="" style="width:100%;">
  </div>
</div>
<!-- Footer -->
<footer>
